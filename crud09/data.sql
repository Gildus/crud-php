...
insert  into `cliente`(`idcliente`,`nombre_cliente`,`status`) values (1,'Nombre de algun cliente','N');
insert  into `cliente`(`idcliente`,`nombre_cliente`,`status`) values (2,'bbbbbb','N');
insert  into `cliente`(`idcliente`,`nombre_cliente`,`status`) values (3,'Nombre de Cliente 3','N');
...
insert  into `cliente`(`idcliente`,`nombre_cliente`,`status`) values (7,'Nuevo cliente ZZZZ','E');
...
insert  into `facturadet`(`idfacturadet`,`idfacturaenc`,`descripcion`,`monto`) values (1,1,'Detalle de item 1','200.00');
...
insert  into `facturaenc`(`idfacturaenc`,`idcliente`,`nro_factura`,`fecha`,`detalle`,`status`) values (1,1,'001-123456','2013-07-17','aaaaa','N');
...
insert  into `facturaenc`(`idfacturaenc`,`idcliente`,`nro_factura`,`fecha`,`detalle`,`status`) values (4,1,'001-00001','2013-07-17','Pago del Vehiculo ZZZZ.','N');
...
insert  into `usuario`(`id`,`usuario`,`password`,`nombres`,`correo`) values (5,'roxana','848df9bb06c02a5023fb1576577ed1da','Roxana','roxana@gmail.com');
