...
foreach($clientes as $item){ ?>
				<tr>
					...
					<td>
						<a class="btn btn-default btn-xs" href="edit.php?id=<?php echo $item['idcliente'];?>">Editar</a>						
						<a class="btn btn-danger btn-xs" href="delete.php?id=<?php echo $item['idcliente'];?>">Eliminar</a>
					</td>
				</tr>
